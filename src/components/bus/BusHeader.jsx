    ...
    <div className="flex items-start space-x-6 mb-4">
      ...
      <div className="flex flex-col justify-center items-start">
        <div className="flex items-center gap-3 mb-2">
          <h1 className="text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-blue-500 to-purple-600 leading-tight">
            {raid.name}
          </h1>
          
          {/* Gold reward indicator */}
          <div className="flex items-center px-3 py-1 rounded-full bg-gradient-to-r from-yellow-400/10 to-amber-400/10 border border-yellow-400/20 shadow-sm">
          ...
          <div className="flex items-center px-3 py-1 rounded-full bg-gradient-to-r from-purple-400/10 to-pink-400/10 border border-purple-400/20 shadow-sm">
