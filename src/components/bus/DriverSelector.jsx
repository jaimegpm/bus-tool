      ...
      <div className="flex flex-col sm:flex-row sm:items-center space-y-3 sm:space-y-0 sm:space-x-4">
        <div className="flex items-center bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
          ...
          <input
            ...
            className="w-16 text-center py-2.5 border-x border-gray-200 dark:border-gray-700 bg-transparent focus:outline-none focus:ring-2 focus:ring-inset focus:ring-blue-500 text-gray-900 dark:text-gray-100 font-medium"
        ...
        <div className="flex-shrink-0 bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
          <div className="flex items-center">
            <div className="px-4 py-2.5 bg-gradient-to-r from-blue-100 to-indigo-200 dark:from-blue-800/40 dark:to-indigo-700/40 text-blue-800 dark:text-blue-200 font-bold text-lg flex items-center justify-center border-r border-gray-200 dark:border-gray-700">
              {drivers}c{buyers}
            </div>
            ...
            <div className="flex items-center px-4 py-2.5">
              <div className="flex items-center mr-3">
                ...
                <span className="text-sm text-gray-700 dark:text-gray-300">
                  {drivers} <span className="text-gray-500 dark:text-gray-400 text-xs">driver{drivers !== 1 ? 's' : ''}</span>
                </span>
              </div>
              ...
              <div className="flex items-center">
                ...
                <span className="text-sm text-gray-700 dark:text-gray-300">
                  {buyers} <span className="text-gray-500 dark:text-gray-400 text-xs">buyer{buyers !== 1 ? 's' : ''}</span>
                </span>
              </div>
            </div>
          </div>
