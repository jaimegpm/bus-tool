            ...
            <div className="bg-white/90 dark:bg-gray-800/90 rounded-lg p-2 sm:p-4 shadow-md">
              <div className="overflow-x-auto">
                <table className="w-full text-xs sm:text-sm">
                  <thead>
                    <tr>
                      <th className="w-1/3 text-center py-2 sm:py-3 font-semibold text-gray-700 dark:text-gray-300 border-b-2 border-gray-200 dark:border-gray-700">Driver</th>
                      <th className="w-1/3 text-center py-2 sm:py-3 font-semibold text-gray-700 dark:text-gray-300 border-b-2 border-gray-200 dark:border-gray-700">Buyer</th>
                      <th className="w-1/3 text-center py-2 sm:py-3 font-semibold text-gray-700 dark:text-gray-300 border-b-2 border-gray-200 dark:border-gray-700">Gold</th>
                    </tr>
                  </thead>
                  <tbody>
                        ...
                        <tr key={index} className="hover:bg-gray-50/80 dark:hover:bg-gray-700/50 transition-colors group border-b border-gray-100 dark:border-gray-800">
                          <td className="py-2 sm:py-3 text-center">
                            <div className="flex justify-center">
                              <span className={`inline-flex items-center justify-center w-6 h-6 sm:w-8 sm:h-8 rounded-full ${driverColor.bg} transition-all duration-300 ${driverColor.text} ${driverColor.border} ${driverColor.shadow} ${driverColor.hover} text-xs sm:text-sm font-bold`}>
                                d{item.driver}
                              </span>
                            </div>
                          </td>
                          <td className="py-2 sm:py-3 text-center">
                            <div className="flex justify-center">
                              <span className={`inline-block px-2 sm:px-3 py-1 sm:py-1.5 rounded-md text-xs font-medium ${driverColor.bg} ${driverColor.text} transition-all duration-300 ${driverColor.border} ${driverColor.shadow} ${driverColor.hover}`}>
                                {item.buyer}
                              </span>
                            </div>
                          </td>
                          <td className="py-2 sm:py-3 text-center">
                            <div className="flex justify-center">
                              <span className={`flex items-center px-2 sm:px-3 py-1 sm:py-1.5 rounded-md ${driverColor.bg} ${driverColor.text} transition-all duration-300 ${driverColor.border} ${driverColor.shadow} ${driverColor.hover}`}>
                                <img src={goldIconUrl} alt="Gold" className="w-3 h-3 sm:w-4 sm:h-4 mr-1 sm:mr-1.5" />
